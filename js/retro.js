const loadNews = async (catid) => {
    ...
    <div class="avatar">
    <div class="w-16 h-16 rounded-xl mt-10 ml-10">
      <img src="${item.image}" />
    </div>
    </div>
                    <div class="card-body space-y-2">
                      ...
                      <div class="card-actions justify-end">
                        <button onclick="buttonClick()" id="btn-click" class="btn button  rounded-full bg-[#10B981] text-white"><i class="fa-solid fa-envelope"></i></button>
                      </div>
                    </div>
                  </div>
    ...
    data.forEach((item) => {
        ...
        <div class="card w-96 h-[482px] bg-base-100 border border-[#12132D26] pl-10 gap-y-5">
                    ...
                    <div class=" flex text-base font-normal gap-x-5">
                     ...
                     <p class="text-base font-normal ">${item.author.posted_date}</p>
                     </div>
                      ...
                      <div class="flex gap-x-10">
                        ...
                        <p class="text-base font-normal">${item.author.designation}</p>
                        </div>
...
function buttonClick (){
    ...
    h4.innerText = '${item.category}'
    icon.innerText = '<i class="fa-regular fa-eye mr-2"></i>'
    p.innerText = '${item.view_count}'
